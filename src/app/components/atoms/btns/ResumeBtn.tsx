    ...
    <div className="top-24 w-52 my-3 py-2">
      <Menu>
        ...
        >
          ...
          */}
          <MenuItem>
            <a className='group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 hover:no-underline no-underline hover:text-white data-[focus]:bg-white/10' href='/resume/hamza_laaroussi_dev_resume_eng.pdf' target="_blank" rel="noopener noreferrer" title='download my resume'>
              English version
            </a>
          </MenuItem>
