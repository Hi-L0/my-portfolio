        ...
        <div className={`group relative my-10 grid pb-3 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50 ${displayed?'opacity-100':"opacity-40"}`}>
            ...
            <div className='sm:col-span-6'>
                <div className=' hover:text-3xl'>
                    <a href={data.post.project_url} target='_blank' className={`flex justify-items-start justify-between text-[#cbd5e1] font-semibold hover:text-teal-400 ${!displayed ?  selected===data.id? 'text-teal-400':"":""} no-underline hover:no-underline`}>
