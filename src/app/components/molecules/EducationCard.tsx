...
function EducationCard({data}:{data:educationType}) {
  return (
    <div>
        <div className={`group relative my-0 grid pb-3 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50`}>
